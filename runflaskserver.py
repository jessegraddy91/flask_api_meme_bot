...
article_put_args.add_argument(
    "date", type=int, help="date of the article is required", required=True
)
article_put_args.add_argument(
    "title", type=str, help="title of the article", required=True
)
article_put_args.add_argument(
    "link", type=str, help="link on the article", required=True
)
article_put_args.add_argument(
    "main_art", type=bool, help="has been main article", required=False
)

article_update_args = reqparse.RequestParser()
article_update_args.add_argument(
    "date", type=int, help="date of the article is required"
)
article_update_args.add_argument(
    "title", type=str, help="title of the article is required"
)
article_update_args.add_argument(
    "link", type=str, help="link on the article is required"
)
article_update_args.add_argument("main_art", type=bool, help="has been main article")
